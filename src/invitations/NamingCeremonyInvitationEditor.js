...
import haldiInvitationElements from "../data/namingceremonyInvitationData";
...
export default function NamingCeremonyInvitationEditor() {

  const stageRef = useRef();
  const transformerRef = useRef();

  const [elements, setElements] = useState(haldiInvitationElements);
