...
import unicornInvitationElements from "../data/unicornInvitationData";
...
export default function UnicornInvitationEditor() {

  const stageRef = useRef();
  const transformerRef = useRef();

  const [elements, setElements] = useState(unicornInvitationElements);
