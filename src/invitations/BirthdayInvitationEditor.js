...
import birthdayInvitationElements from "../data/birthdayInvitationData";
...
export default function BirthdayInvitationEditor(){
...
const [bgColor,setBgColor] = useState("#f6c5f1");
