...
import seminarInvitationElements from "../data/seminarInvitationData";
...
export default function SeminarInvitationEditor() {

  const stageRef = useRef();
  const transformerRef = useRef();

  const [elements, setElements] = useState(seminarInvitationElements);
  ...
  const downloadPDF = () => {
    ...
    pdf.save("Seminar Invitation.pdf");
  };
