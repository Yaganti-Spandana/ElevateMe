...
import techfestInvitationElements from "../data/techfestInvitationData";
...
export default function TechfesteventInvitationEditor() {

  const stageRef = useRef();
  const transformerRef = useRef();

  const [elements, setElements] = useState(techfestInvitationElements);
...
document.body.removeChild(textarea);
  ...
  const downloadPDF = () => {
    ...
    pdf.save("Tech Fest Invitation.pdf");
  };
