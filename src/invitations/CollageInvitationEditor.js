...
import collageInvitationData from "../data/collageInvitationData";
...
export default function CollageInvitationEditor() {

  const stageRef = useRef();
  const transformerRef = useRef();

  const [template] = useState(collageInvitationData);
const [elements, setElements] = useState(collageInvitationData.elements);
