...
import kittyPartyInvitationElements from "../data/kittypartyInvitationData";
...
export default function KittypartyInvitationEditor(){

const stageRef = useRef();
const transformerRef = useRef();

const [elements,setElements] = useState(kittyPartyInvitationElements);
const [selectedId,setSelectedId] = useState(null);

const [font,setFont] = useState("Arial");
const [color,setColor] = useState("#000");
const [bgColor,setBgColor] = useState("turquose");
