...
import jobfairInvitationElements from "../data/jobfairInvitationData";
...
export default function JobfairInvitationEditor() {

  const stageRef = useRef();
  const transformerRef = useRef();

  const [elements, setElements] = useState(jobfairInvitationElements);
  ...
  const downloadPDF = () => {
    ...
    pdf.save("Job Fair Invitation.pdf");
  };
