...
import cradleInvitationData from "../data/cradleInvitationData";
...
export default function CradleInvitationEditor() {

  const stageRef = useRef();
  const transformerRef = useRef();

  const [template] = useState(cradleInvitationData);
const [elements, setElements] = useState(cradleInvitationData.elements);
