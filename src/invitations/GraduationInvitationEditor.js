...
import graduationInvitationData from "../data/graduationInvitationData";
...
export default function GraduationInvitationEditor() {

  const stageRef = useRef();
  const transformerRef = useRef();

  const [template] = useState(graduationInvitationData);
const [elements, setElements] = useState(graduationInvitationData.elements);
