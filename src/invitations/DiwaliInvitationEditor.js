...
import diwaliInvitationElements from "../data/diwaliInvitationData";
...
export default function DiwaliInvitationEditor() {

  const stageRef = useRef();
  const transformerRef = useRef();

  const [elements, setElements] = useState(diwaliInvitationElements);
  ...
  const downloadPDF = () => {
    ...
    pdf.save("Diwali Invitation.pdf");
  };
