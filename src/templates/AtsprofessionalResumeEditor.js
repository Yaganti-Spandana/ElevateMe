...
import "../css/AtsprofessionalResumeEditor.css";
...
const AtsprofessionalResumeEditor = () => {
  const templateId = "atsprofessional";
...
useEffect(() => {
  ...
  // =========================
   const handleDownload = async () => {
    ...
    const pages = resumeRef.current.querySelectorAll(".atsprofesional_pdf-page");
  ...
  const ResumeInner = () => (
    <>
      ...
      {common.summary && (
        <section className="atsprofessional_section-block">
          <h3 className="atsprofessional_section-headingcareer">Professional Summary</h3>
          <p className="atsprofessional_summary">{common.summary}</p>
        </section>
      )}

      {common.skills?.length > 0 && (
      <section className="atsprofessional_section-block">
        <h3 className="atsprofessional_section-headingcareer">Skills</h3>
        <ul className="atsprofessional_listcareer">
        {common.skills.map((skill, idx) => (
            <div key={idx} className="pdf-section1">
              <li className="atsprofessional_skill-gapcareer"> <div>{skill}</div></li>
            </div>
          ))}</ul>
      </section>
    )}
    ...
    {education?.length > 0 && (
        <section className="atsprofessional_section-block">
          <h3 className="atsprofessional_section-headingcareer">Education</h3>
          <div className="ed1">
              <div className="deg1">
          ...
          {education.map((edu, idx) => (
            <div key={idx} className="pdf-sectionintern">
              <div className="ed" style={{fontSize:"14px"}}>
              <div className="deg">
              {edu.degree} </div> 
      ...
      {experience?.length > 0 && (
  <section className="atsprofessional_section-block">
    <h3 className="atsprofessional_section-headingcareer">Professional Experience</h3>
    {experience.map((item, idx) => (
      <div key={idx} className="pdf-sectionintern" style={{fontSize:"12px"}}>
      ...
      {projects?.length > 0 && (
        <section className="atsprofessional_section-block">
          <h3 className="atsprofessional_section-headingcareer">Projects</h3>
      ...
      {certifications?.length > 0 && (
        <section className="atsprofessional_section-block">
          <h3 className="atsprofessional_section-headingcareer">Certifications</h3>
      ...
      <section className="atsprofessional_section-block">
        <h3 className="atsprofessional_section-headingcareer">Achievements</h3>
        <ul className="listcareer">
        {achievements.map((skill, idx) => (
            <div key={idx} className="pdf-section1" style={{fontSize:"12px"}}>
    ...
    {languages?.length > 0 && (
      <section className="atsprofessional_section-block">
        <h3 className="atsprofessional_section-headingcareer">Languages</h3>
        <ul className="listcareer">
...
const handleCreatePortfolio = () => {
  ...
  window.open(`/portfolio/atsprofessional/${portfolioId}`, "_blank");
};
  // =========================
  // JSX
  // =========================
...
<div className="atsprofesional_resume-content">
<ResumeInner />
</div>
</div>
...
<div key={pageIndex} className="atsprofesional_pdf-page">
...
export default AtsprofessionalResumeEditor;