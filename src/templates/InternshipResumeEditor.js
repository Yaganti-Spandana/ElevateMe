...
import "../css/InternshipResumeEditor.css";
...
const InternshipResumeEditor = () => {
  const templateId = "internship";
...
const splitIntoPages = useCallback((container) => {
  ...
  const sections = Array.from(
    container.querySelectorAll(".header-blockintern, .section-blockintern")
  );
...
useEffect(() => {
  ...
  // =========================
   const handleDownload = async () => {
    ...
    const pages = resumeRef.current.querySelectorAll(".pdf-pageintern");
  ...
  const ResumeInner = () => (
    <>
      <div className="header-blockintern">
        <div className="contactintern">
        <p>{common.contact?.email}</p><p>{common.contact?.phone}</p>
        <p>{common.contact?.linkedin} </p><p>{common.contact?.github}</p>
      </div><div className="name">
      <h1 className="headingintern">{common.name}</h1>
      <h2 className="subheadingintern">{common.title}</h2></div>
    </div>

      {common.summary && (
        <section className="section-blockintern">
          <h3 className="section-headingintern">Professional Summary</h3>
      ...
      {common.skills?.length > 0 && (
        <section className="section-blockintern">
          <h3 className="section-headingintern">Skills</h3>
          <p className="skills-textintern">{common.skills.join(", ")}</p>
        </section>
      )}

      {internships?.length > 0 && (
  <section className="section-blockintern">
    <h3 className="section-headingintern">Internships</h3>
    {internships.map((item, idx) => (
      ...
      {education?.length > 0 && (
        <section className="section-blockintern">
          <h3 className="section-headingintern">Education</h3>
          <div className="ed1">
              <div className="deg1">
      ...
      {projects?.length > 0 && (
        <section className="section-blockintern">
          <h3 className="section-headingintern">Projects</h3>
      ...
      {certifications?.length > 0 && (
        <section className="section-blockintern">
          <h3 className="section-headingintern">Certifications</h3>
...
window.open(`/portfolio/internship/${portfolioId}`, "_blank");
...
<div key={pageIndex} className="pdf-pageintern">
...
export default InternshipResumeEditor;